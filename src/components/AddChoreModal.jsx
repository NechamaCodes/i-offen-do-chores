...
export default function AddChoreModal({ onClose }) {
  ...
  function handleSubmit(e) {
    ...
    if (loadPercent >= 100) {
      return setError(`${members.find(m => m.id === form.assignedTo)?.name} is already at max capacity!`)
    }
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <h2 className="text-lg font-bold text-gray-900">Add a Chore</h2>
          ...
          <div>
            ...
            {form.category === '__custom__' && (
              <input
                ...
                onChange={handleChange}
                className="mt-2 w-full border border-purple-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400"
